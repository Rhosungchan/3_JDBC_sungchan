...
public class EmployeeView {
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				sc.next(); // 입력 버퍼에 남아있는 잘못 입ㄺ도니 문자를
	...
	private void printAll(List<Employee> empList) {
	...
	public void insertEmployee() {
		...
		Employee emp = new Employee(empId, empName, empNo, email, phone, salary, deptCode, jobCode, selLevel, bonus,
				managerId);

...
COMMENT ON COLUMN "BOARD".MEMBER_NO IS '게시글 회원번호';
...
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 4', '샘플 내용 3입니다.',
       DEFAULT, DEFAULT, DEFAULT, 3);

UPDATE "BOARD" SET
BOARD_CONTENT = '샘플 내용 1입니다.'
WHERE BOARD_NO = 1;
...
-- 1분 차이 == 1/24/60
-- 1초 차이 == 1/24/60/60
SELECT SYSDATE - TO_DATE('2022-09-21')
FROM DUAL;
...
SELECT BOARD_NO, BOARD_TITLE , BOARD_CONTENT,
       MEMBER_ID, MEMBER_NM, READ_COUNT,
